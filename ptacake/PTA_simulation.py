...
try:
    ...
    print('Warning: seaborn not installed. Coupling plots will fail.')
...
class PTA_sim:
    ...
    def plot_coupling(self, **kwargs):
        ...
        heatmap_kwargs = dict(cmap='RdBu_r', square=True, center=0, ax=ax,
                              xticklabels=lm, yticklabels=lm)
        heatmap_kwargs.update(kwargs)
        sns.heatmap(K, **heatmap_kwargs)
        plt.xlabel(r'$(\ell, m)$')
        plt.ylabel(r'$(\ell, m)$')
